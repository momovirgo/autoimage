  ...
  try {
    ...
    const TEXTS = {
      ...
      nl: {
        ...
        resizeSuccess: "✅ Afbeelding verkleind naar {width} x {height}",
    ...
    const WPlaceService = {
      async paintPixelInRegion(regionX, regionY, pixelX, pixelY, color) {
        try {
          ...
          console.log(`Paint attempt at ${pixelX},${pixelY} with color ${color}: success=${data?.painted === 1}, response=`, data);
    ...
    function findClosestColor(rgb, palette) {
      if (palette.length === 0) return 0; // Default if no colors
    ...
    async function createUI() {
      try {
        ...
        fontAwesome.onload = () => console.log('Font Awesome loaded');
        fontAwesome.onerror = (e) => console.error('Error loading Font Awesome:', e);
        ...
        console.log('UI elements appended to body');
        ...
        function showResizeDialog(processor) {
          try {
            ...
            console.error('Error showing resize dialog:', e);
          }
        }
        ...
        selectPosBtn.addEventListener('click', async () => {
          try {
            ...
            console.error('Error selecting position:', e);
          }
        });
        ...
        startBtn.addEventListener('click', async () => {
          try {
            ...
            console.error('Error starting painting:', e);
